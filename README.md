[![New Relic Community header](https://raw.githubusercontent.com/newrelic/open-source-office/master/examples/categories/images/Community_Project.png)](https://docs.newrelic.com/docs/licenses/open-source/oss-category/#community-project)
...
###### `request_timeout` (global)

| Description | Valid Values | Required | Default |
| --- | --- | --- | --- |
| Global request timeout to use for all HTTPS requests, in seconds | integer | N | 5 |

This parameter specifies the timeout to use for all HTTPS requests made by the
exporter, including Salesforce authentication requests and all Salesforce API
requests.

This parameter can be overriden at the [instance](#instances) level using the
instance [`request_timeout`](#request_timeout) parameter. If both are specified,
the instance level parameter takes precedence.
...
| Description | Valid Values | Required | Default |
| --- | --- | --- | --- |
| The request timeout to use for all HTTPS requests made for this instance, in seconds | integer | N | global [`request_timeout`](#request_timeout-global) |

This parameter specifies the timeout to use for all HTTPS requests made by the
exporter for this instance, including Salesforce authentication requests and all
Salesforce API requests.

This parameter can be used to override the global [`request_timeout`](#request_timeout-global).
for this instance. If both are specified, the instance level parameter takes
precedence.
