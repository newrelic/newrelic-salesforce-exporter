...
This integration automatically generates logs to trace its health state and correct functioning. Logs are generated in the standard output as JSON objectes, each line being an object. This will help other integrations and tools to collect these logs and handle them properly. The JSON object contains the following keys:
